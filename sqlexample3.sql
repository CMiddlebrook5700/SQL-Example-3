...
SELECT player_name, position FROM player_name LEFT JOIN gameday_performance 
ON player_name.player_number=gameday_performance.player_number
WHERE td_catch > 3 AND college = 'LSU'
ORDER BY player_name ASC;CREATE TABLE `gameday_performance` (
